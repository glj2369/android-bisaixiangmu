...
public class TiKu14Pager4Fragment extends Fragment {
    ...
    private void barView() {
        ...
        lineChart.setGridBackgroundColor(Color.rgb(82,198,247));
        lineChart.setDescription("");
        lineChart.setDrawBorders(false);
        lineChart.getAxisLeft().setStartAtZero(false);
        textview_show.setText(getString(R.string.pager4,max));
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(context).inflate(R.layout.tiku_14_pager4, null);
