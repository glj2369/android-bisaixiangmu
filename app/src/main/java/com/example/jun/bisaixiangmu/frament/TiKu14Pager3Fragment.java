...
public class TiKu14Pager3Fragment extends Fragment {
    ...
    private void barView() {
        ...
        for (int i = 0; i < 20; i++) {
            int profit = random.nextInt(40)+30;
        ...
        textview_show.setText(getString(R.string.pager3,max));
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(context).inflate(R.layout.tiku_14_pager3, null);
